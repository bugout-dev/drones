...
env_param_mapping = {
    ...
    "BUGOUT_REDIS_URL": "/drones/prod/BUGOUT_REDIS_URL",
    "REDIS_FAILED_REPORTS_QUEUE": "/drones/prod/REDIS_FAILED_REPORTS_QUEUE",
    "REDIS_REPORTS_QUEUE": "/drones/prod/REDIS_REPORTS_QUEUE",
    "REDIS_REPORTS_CHUNK_SIZE": "/drones/prod/REDIS_REPORTS_CHUNK_SIZE",
    "WAITING_UNTIL_NEW_REPORTS": "/drones/prod/WAITING_UNTIL_NEW_REPORTS"
}
